...
public class IntefaceMethod extends InterfaceMethodDecl {

    private MethodType MethodType;
    private String I2;
    private FormPars FormPars;

    public IntefaceMethod (MethodType MethodType, String I2, FormPars FormPars) {
